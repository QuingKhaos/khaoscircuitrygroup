...
You just need to add `khaoscircuitrygroup` as optional dependency without any other changes. All your conditional checks for Schall Circuit Group will work with this mod too.
